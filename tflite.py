...
scaler = MinMaxScaler()
data_temp = pandas.read_csv('/home/sanslab/test/2019/1.csv', usecols=['Temperature Number'])
data_salt = pandas.read_csv('/home/sanslab/test/data_test/Salt.csv', usecols=['Salt'])
data_ph = pandas.read_csv('/home/sanslab/test/data_test/PH.csv', usecols=['PH'])
data_nh3 = pandas.read_csv('/home/sanslab/test/data_test/NH3.csv', usecols=['NH3'])
data_h2s = pandas.read_csv('/home/sanslab/test/data_test/H2S.csv', usecols=['H2S'])
data_tss = pandas.read_csv('/home/sanslab/test/data_test/TSS.csv', usecols=['TSS'])
data_do = pandas.read_csv('/home/sanslab/test/data_test/DO.csv', usecols=['DO'])
data_cod = pandas.read_csv('/home/sanslab/test/data_test/COD.csv', usecols=['COD'])
